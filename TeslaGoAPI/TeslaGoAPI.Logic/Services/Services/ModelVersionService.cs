...
{
    public sealed class ModelVersionService(IUnitOfWork unitOfWork, IAuthService authService)
       : GenericService<
           ModelVersion,
           ModelVersionRequestDto,
           ModelVersionRequestDto,
           ModelVersionResponseDto,
           ModelVersionQuery>(unitOfWork, authService), IModelVersionService
    {
